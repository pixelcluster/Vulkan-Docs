...
[open,refpage='VkPhysicalDeviceMemoryInitializationControlFeaturesFROG',desc='Structure describing the memory initialization control features of a physical device',type='structs']
--
The sname:VkPhysicalDeviceMemoryInitializationControlFeaturesFROG structure is
defined as:
...
This structure describes the following features:
  ...
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:memoryInitializationControl indicates whether the implementation
    supports application-controlled memory initialization via the
    sname:VkMemoryInitializationCreateInfoFROG structure.
