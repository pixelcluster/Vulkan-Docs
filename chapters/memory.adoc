...
ifdef::VK_FROG_memory_initialization_control[]
  * If the pname:pNext chain includes a
    slink:VkMemoryInitializationCreateInfoFROG, the bit corresponding to
    pname:memoryTypeIndex must: be set in
    slink:VkPhysicalDeviceMemoryInitializationControlPropertiesFROG::pname:supportedMemoryTypes
endif::VK_FROG_memory_initialization_control[]
****
...
ifdef::VK_FROG_memory_initialization_control[]
[open,refpage='VkMemoryInitializationCreateInfoFROG',desc='Structure controlling initialization of device memory by an implementation',type='structs']
--
The sname:VkMemoryInitializationCreateInfoFROG structure is defined as:
...
include::{generated}/api/structs/VkMemoryInitializationCreateInfoFROG.adoc[]
  ...
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:memoryInitializationMode is a elink:VkMemoryInitializationModeFROG
    value controlling the memory initialization.

include::{generated}/validity/structs/VkMemoryInitializationCreateInfoFROG.adoc[]
--

[open,refpage='VkMemoryInitializationModeFROG',desc='Memory initialization control modes',type='enums']
--
Possible values for ename:VkMemoryInitializationModeFROG include:

include::{generated}/api/enums/VkMemoryInitializationModeFROG.adoc[]

  * ename:VK_MEMORY_INITIALIZATION_MODE_DEFAULT_FROG specifies that the
    implementation should: use its default mechanisms to initialize memory.
  * ename:VK_MEMORY_INITIALIZATION_MODE_DONT_CARE_FROG specifies that the
    implementation should: not attempt to initialize the contents of the
    allocated device memory except if needed to provide required security
    guarantees.
  * ename:VK_MEMORY_INITIALIZATION_MODE_FILL_ZERO_FROG specifies that the
    contents of the allocated device memory must: be filled with zero.
--
endif::VK_FROG_memory_initialization_control[]
