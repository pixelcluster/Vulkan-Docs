...
// VK_FROG_shader_continuation is a preprocessor guard. Do not pass it to API calls.
#define VK_FROG_shader_continuation 1
#define VK_FROG_SHADER_CONTINUATION_SPEC_VERSION 1
typedef VkDeviceAddress (VKAPI_PTR *PFN_vkGetShaderContinuationAddressFROG)(VkPipeline pipeline);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR VkDeviceAddress VKAPI_CALL vkGetShaderContinuationAddressFROG(
    VkPipeline                                  pipeline);
#endif
